...
\date{Version 1.0dev, 2015/02/24}
...
\item Fortcoming (v.\,1.0): Add option to add the instructor's name to both the course (via
    ...
    (via \joption{instructor} option of \jcsmacro{NewSession}); add option to add names of
    presenting students to a session (via \joption{presstudents} option); fix expansion issue
    in \joption{options} option of \jcsmacro{makebeamerprogram}.
