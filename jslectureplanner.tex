...
\end{quote}
The number of rows depends on the \joption{<number of students>} argument,
the number of columns, on the other hand, is always 3, tracking \emph{student id},
...
The header strings, however, can easily be changed by redefining the following three
...
\emph{before} \jsmt\ if you want to use this feature. Then just insert:
