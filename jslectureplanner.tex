...
\title{The \emph{jslectureplanner} bundle}
...
Presence tables consist of rows where your students fill in their name and columns
...
to generate a matching number of columns with the respective session date as
column header.
