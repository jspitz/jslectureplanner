...
\date{Version 1.2dev, 2016/05/07}
...
\subsection{Generating session-specific information for the next session}

Depending on the value of \jcsmacro{ThisSession}, you can retrieve the following
information for the next session via the following macros:
\begin{itemize}
	\item \jcsmacro{NextSessionTitle}: Outputs the main title
	of the next session
	\item \jcsmacro{NextSessionFullTitle}: Outputs the full
	title (main title, separator, subtitle) of the next session
	\item \jcsmacro{NextSessionShortTitle}: Outputs the short
	title of the next session
	\item \jcsmacro{NextSessionDate}: Outputs the date of the next session
	\item \jcsmacro{NextSessionShortDate}: Outputs the short
	date (no year) of the next session
	\item \jcsmacro{NextSessionInstructor}: Outputs the name of the instructor of the next session
	\item \jcsmacro{NextSessionPresStudents}: Outputs the name of the students presenting
	in the next session
	\item \jcsmacro{NextSessionRoom}: Outputs the room of the next session
\end{itemize}
