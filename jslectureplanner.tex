...
\date{Version 1.5dev, 2017/03/11}
...
\begin{itemize}
\item \jcsmacro{SessionTitleSep\{<title separator>\}}: Specify a default separator between session title and subtitle (e.\,g., ``. '' or `` -- ''). This is used if no specific separator has been specified in the session entry (see sec.~\ref{sec:lecplan})
\end{itemize}
