...
and \ref{sec:session-specific-info} to retrieve the respective data and use
it in your documents.
\end{itemize}
...
your university
\item \jcsmacro{LecInstitute\{<institute>\}}: Record your institute
name
