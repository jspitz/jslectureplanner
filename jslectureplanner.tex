...
\date{Version 1.1dev, 2015/07/08}
...
and one smaller companion package: \textsf{jsmembertable}, a package to generate
course member tables. This manual documents these packages.
\end{abstract}
...
\textsf{xkeyval}, \textsf{datetime}, \textsf{calc}, \textsf{ifthen}.
...
\subsection{Generating student presentation lists}
...
\item Forthcoming (v. 1.1dev):
     \begin{itemize}
       \item Include and document the \textsf{jsmembertable} package.
       \item Add support for student presentation lists (new macros \jcsmacro{makepreslist},
             \jcsmacro{makepreslist*}, \jcsmacro{makebeamerpreslist} and
             \jcsmacro{setfirstpressession}).
     \end{itemize}
