...
\date{Version 0.8dev, 2015/01/15}
...
\begin{itemize}
\item forthcoming (v. 0.8): Fix corruption of \jfcsmacro{today}; add option and macro to set a room for the course as well as a session-specific room.
