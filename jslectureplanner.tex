...
\date{Version 1.6dev, 2018/09/25}
...
\begin{itemize}
\item forthcoming (v. 1.6):
	\begin{itemize}
	    \item Do not output session title-subtitle separator if there is no	subtitle.
	    \item Add \joption{blocksonly} option to \jcsmacro{makebeamerprogram}.
    \end{itemize}
