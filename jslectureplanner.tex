...
provided by Herbert Voss (\url{http://tex.stackexchange.com/a/7594}); the \jslp\ package
uses code to test for \jfcsmacro{romannumeral} arguments which has been taken from
